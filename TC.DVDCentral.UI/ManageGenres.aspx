<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageGenres.aspx.cs" Inherits="TC.DVDCentral.UI.ManageGenres" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <h2>Genre Management</h2>
        <div class="form-row ml-2 mt-2">
            <div class="control-label col-md-2">
                <asp:Label ID="DropdownLabel" runat="server" Text="Genres: "></asp:Label>
            </div>
            <div class="control-label col-md-10">
                <asp:DropDownList ID="GenreDropDownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="GenreDropDownList_SelectedIndexChanged">
                </asp:DropDownList>
            </div>
        </div>
        <div class="form-row ml-2 mt-2">
